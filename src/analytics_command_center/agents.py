...
class AnalysisAgent:
    ...
    def propose(self, question: str, analysis_lens: str, analysis_hint: str | None, catalog: SchemaCatalog) -> SQLProposal:
        ...
        return self._run(
            ...
            "For a filtered aggregate, include a numeric matching_row_count field alongside the aggregate so no matches remain distinguishable "
            "from real zero-valued matches. The supplied schema is governed: unavailable fields, including restricted fields, must never be "
            "disclosed in schema answers or SQL. "
